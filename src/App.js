...
import './components/js/animating.js'
import './components/js/imagesloaded.pkgd.min.js'
...
import './components/js/perfect-scrollbar.min.js'
import './components/js/validator.js'
...
function App() {
  ...
  // const value = 'World';
  // return <div>Hello {value}, the dream has begun</div>;
}
